...
exports.run = (client, message, params) => {
  ...
  .addField("**» Yeni Komutlar**", `!herkese-rol-ver = Seçili Rolü Herkesten Alır. \n!herkesten-rol-al = Seçili Rolü Herkesten Alır. \n!söv = Etiketlenen Kullanıcıya Söver. \n!sifre = Belirtilen Miktarda Şifre Oluşturur.`)
